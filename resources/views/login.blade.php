...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; background: #2561e8; min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 24px 16px; }
        ...
        .logo h1 { font-size: 26px; font-weight: 800; color: #2561e8; }
        .logo p { font-size: 14px; color: #666; margin-top: 4px; }
        h2 { font-size: 20px; font-weight: 700; color: #040a17; margin-bottom: 20px; }
        .field { margin-bottom: 16px; }
        label { display: block; font-size: 13px; font-weight: 600; color: #333; margin-bottom: 6px; }
        input[type=email], input[type=password], input[type=text] { width: 100%; padding: 11px 14px; border: 1.5px solid #ddd; border-radius: 8px; font-size: 15px; color: #040a17; outline: none; background: #fafafa; }
        input:focus { border-color: #2561e8; background: #fff; }
        ...
        .btn { width: 100%; padding: 13px; background: #2561e8; color: #fff; border: none; border-radius: 8px; font-size: 16px; font-weight: 700; cursor: pointer; margin-top: 20px; }
