...
body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; background: #f1f5f9; min-height: 100vh; padding: 32px 16px 48px; color: #040a17; }
...
.step.done .step-num { background: #2561e8; color: #fff; }
.step.active .step-num { background: #2561e8; color: #fff; box-shadow: 0 0 0 4px #e7eefc; }
...
.field input[type=email] { width: 100%; padding: 10px 14px; border: 1.5px solid #cbd5e1; border-radius: 8px; font-size: 15px; color: #040a17; outline: none; background: #f8fafc; transition: border-color .2s; }
.field input:focus { border-color: #2561e8; background: #fff; }
.hint { font-size: 12px; color: #94a3b8; margin-top: 5px; display: block; }
.field-row { display: flex; gap: 16px; }
.field-row .field { flex: 1; }
.btn-primary { display: block; width: 100%; padding: 14px; background: #2561e8; color: #fff; border: none; border-radius: 10px; font-size: 16px; font-weight: 700; cursor: pointer; transition: background .2s; }
...
.btn-test:hover:not(:disabled) { border-color: #2561e8; color: #2561e8; }
...
.info-box { background: #eff6ff; border: 1px solid #e7eefc; border-radius: 8px; padding: 14px 16px; font-size: 13px; color: #2561e8; line-height: 1.6; }
.info-box code { background: #e7eefc; padding: 1px 6px; border-radius: 3px; font-family: monospace; }
